<footer class="relative bg-black pt-8 pb-6 xl:mt-60">
            ...
            <div class="w-full md:w-4/12 px-4 mx-auto text-center">
                <div class="text-sm text-blueGray-500 font-semibold py-1">
                    Copyright © <span id="get-current-year">2023</span><a
                        ...
                        class="text-blueGray-500 hover:text-gray-800" target="_blank"> Electro-Maroc by
                        <a href="https://github.com/Karimcherraoui/electromaroc"
                            class="text-blueGray-500 hover:text-blueGray-800">KarimCherraoui</a>.
                </div>
            </div>
        </div>
    </div>
...
<script src="http://localhost/electromaroc/public/js/main.js"></script>
<script src="http://localhost/electromaroc/public/js/addMore.js"></script>
