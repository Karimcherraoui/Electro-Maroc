            ...
            <nav class="flex justify-between bg-gray-900 text-white ">
                <div class="px-5 xl:px-12 py-6 flex w-full items-center">
                    ...
                    <ul class="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
                        ...
                        <li><a class="hover:text-gray-200" href="<?= URLROOT . '/Pages/allproduct' ?>">Products</a></li>

                        <?php if (isset($_SESSION['user_role']) && ($_SESSION['user_role'] === 'admin')) : ?>
                            <li>
                                <a class="hover:text-gray-200" href="<?= URLROOT . '/Products/product' ?>">Dashboard</a>
                            </li>
                            <li>
                                <a class="hover:text-gray-200" href="<?= URLROOT . '/Products/dashboardCmdUser' ?>">Commande-List</a>
                            </li>
                        <?php elseif (isset($_SESSION['user_role']) && ($_SESSION['user_role'] === 'client')) : ?>
                            <li>

                                <a class="hover:text-gray-200" href="<?= URLROOT . '/Products/dashboardCmd' ?>">Commande-List</a>
                            </li>

                        <?php endif; ?>
                        <li><a class="hover:text-gray-200" href="<?= URLROOT . '/Pages/contactUs' ?>">Contact Us</a></li>
                    </ul>
                    <!-- Header Icons -->
                    <div class="hidden xl:flex items-center space-x-5 items-center">
                        ...
                        <?php if (isset($_SESSION['user_id'])) : ?>
                            ...
                            <a class="flex items-center hover:text-gray-200" href="<?= URLROOT . '/Users/logout' ?>">
                        ...
                        <?php else : ?>
                            ...
                            <a class="flex items-center hover:text-gray-200" href="<?= URLROOT . '/users/login' ?>">
