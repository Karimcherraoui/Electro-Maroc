          ...
          <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
            <div class="flex items-start">
              ...
              <div class="grow ml-6">
                ...
                <p class="text-gray-500">support@electromaroc.com</p>
          ...
          <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
            <div class="flex items-start">
              ...
              <div class="grow ml-6">
                ...
                <p class="text-gray-500">sales@electromaroc.com</p>
                <p class="text-gray-500">+1 234-567-89</p>
              </div>
            </div>
          </div>
          <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
            <div class="flex align-start">
              ...
              <div class="grow ml-6">
                ...
                <p class="text-gray-500">press@electromaroc.com</p>
                <p class="text-gray-500">+1 234-567-89</p>
              </div>
            </div>
          </div>
          <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
            <div class="flex align-start">
              ...
              <div class="grow ml-6">
                ...
                <p class="text-gray-500">bugs@electromaroc.com</p>
                <p class="text-gray-500">+1 234-567-89</p>
              </div>
            </div>
          </div>
